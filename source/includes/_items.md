...
stripe_id     | no                                                          | String(255 chars). Only for Stripe `subscription`s. Validates in Stripe that matches a real Stripe Plan Id
interval_unit | no                                                          | Only for Paypal `subscription`s. One of the following: `daily`, `weekly`, `monthly`, `yearly`
interval_frequency  | no                                                    | Decimal. Only for Paypal `subscription`s. Frequency of the units when the charge should recur.
interval_duration  | no                                                     | Decimal. Only for Paypal `subscription`s. Number of times the charge should recur.
